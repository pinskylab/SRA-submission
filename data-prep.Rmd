...
metadata <- samp_lig %>% 
  ...
  select(-organism:-dev_stage, -sample_name) %>% 
...
Have to go into RStudio server on amphiprion and "put" the file names into the metadata table.  Actually, there are few enough that I can hand edit the metadata table.
